...
(async function() {
    ...
    class KryptoriaApi {
        ...
        async searchByUsername(token, username) {
        ...
        async getAssignedByCitizenIds (token, citizenIds){
        ...
        async searchByLandId(token, landId) {
        ...
        async searchByWalletAddress (token, walletAddress) {
